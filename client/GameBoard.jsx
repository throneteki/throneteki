                ...
                <div className='main-window'>
                    <div className='left-side'>
                        <div className='player-info'>
                            <PlayerStats first={ otherPlayer ? (!thisPlayer.firstPlayer ? <img src='/img/FirstPlayerIndicator.png' title='First Player' alt='First Player' /> : '') : ''} gold={otherPlayer ? otherPlayer.gold : 0} claim={otherPlayer ? otherPlayer.claim : 0}
