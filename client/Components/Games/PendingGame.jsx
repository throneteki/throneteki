    ...
    componentWillReceiveProps(props) {
        ...
        if(this.notification && this.state.playerCount === 1 && players === 2 && props.currentGame.owner === this.props.user.username) {
            ...
            if(window.Notification && Notification.permission === 'granted') {
                ...
                let windowNotification = ServiceWorkerRegistration.showNotification('The Iron Throne', { body: `${otherPlayer.name} has joined your game`, icon: `/img/avatar/${otherPlayer.username}.png` });
