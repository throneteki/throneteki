        ...
        return (
            <div className='card-alt'>
                <div className='card-top-row'>
                    ...
                    {['attachment', 'event'].includes(this.props.card.type) && (
                        <div
                            className={`card-faction attachment thronesicon thronesicon-${this.props.card.faction} with-background`}
                        />
                    )}
                </div>
                <div
                    className={classNames('card-icons', {
                        attachment: ['attachment', 'event', 'agenda'].includes(
                ...
                <div
                    className={classNames('card-name-row', {
                        vertical: this.props.card.type === 'location'
                    })}
                >
                    ...
                    {this.props.card.type === 'plot' && (
                        <div className='plot-stats'>
                            <div className='plot-income card-icon'>
                                {this.props.card.plotStats.income}
                            </div>
                            <div className='plot-initiative card-icon'>
                                {this.props.card.plotStats.initiative}
                            </div>
                            <div className='plot-claim card-icon'>
                                {this.props.card.plotStats.claim}
                            </div>
                        </div>
                    )}
                    {['character', 'location', 'plot'].includes(this.props.card.type) && (
                        <div className='card-name'>
                            {this.props.card.unique ? <span className='card-unique' /> : null}{' '}
                            {this.props.card.name}
                        </div>
                ...
                <div className='card-text'>
                    <div className='card-traits'>
                        {this.props.card.traits.join('. ')}
                        {this.props.card.traits.length > 0 ? '.' : null}
                    </div>
                    <span className='text-inner' dangerouslySetInnerHTML={{ __html: cardText }} />{' '}
                    {/* eslint-disable-line */}
                    {['attachment'].includes(this.props.card.type) && (
                        <div className='card-name'>
                            {this.props.card.unique ? <span className='card-unique' /> : null}{' '}
                            {this.props.card.name}
                        </div>
                ...
                {this.props.card.type === 'plot' && (
                    <div className='plot-reserve'>{this.props.card.plotStats.reserve}</div>
                )}
            </div>
        );
    }
