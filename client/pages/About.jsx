            ...
            <div className='col-xs-12 full-height'>
                <Panel title='About The Iron Throne - Help and information'>
                    ...
                    <p>
                        ...
                        <a href='http://dumaker.deviantart.com/' target='_blank'>
                            Dumaker
                        </a>{' '}
                        and can be found{' '}
                        <a
                    ...
                    <p>
                        ...
                        <a href='http://www.thomastanart.com/' target='_blank'>
                            Thomas Tan
                        </a>
                    ...
                    <p>
                        ...
                        <a href='http://www.thenounproject.com' target='_blank'>
                            the Noun Project
                        </a>
                        .
                    </p>
                    ...
                    <p>
                        ...
                        <a target='_blank' href='http://github.com/cryogen/throneteki'>
                            GitHub Repository
                        </a>
                        ...
                        <a target='_blank' href='http://www.twitter.com/cryogen'>
                            Twitter
                        </a>{' '}
                    ...
                    Just to make things clear, I'm not doing this for any personal gain whatsoever,
                    I'm happy to run the servers at my own expense, but any money raised via this
                    link will be used towards paying the hosting fees for the server and related
                    services (error tracking, load balancing etc). If, after the annnual bills for
                    that are paid up, there is any money left over, I'll put it towards the
                    following years expenses. Also, this is not required to continue to use and
                    ...
                    <p>
                        The Game of Thrones living card game, the artwork and many other things are
                        all copyright Fantasy Flight Games and I make no claims of ownership or
                        ...
                        the in person LCG. FFG does not endorse, support, and is not involved with,
