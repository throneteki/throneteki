import FulfillMilitaryClaim from '../../../server/game/gamesteps/challenge/fulfillmilitaryclaim.js';
...
describe('FulfillMilitaryClaim', function () {
    beforeEach(function () {
        ...
        this.loser = jasmine.createSpyObj('loser', ['getNumberOfCardsInPlay', 'filterCardsInPlay']);
        this.loser.getNumberOfCardsInPlay.and.returnValue(0);
        this.loser.filterCardsInPlay.and.returnValue([]);
            ...
            describe('and the loser has enough characters', function () {
                ...
                describe('when enough characters are selected', function () {
                    ...
                    it('should kill the characters', function () {
                        expect(this.game.killCharacters).toHaveBeenCalledWith([
                            this.card1,
                            this.card2
                        ]);
                    });
