    ...
    integration(function() {
        beforeEach(function() {
            const deck1 = this.buildDeck('greyjoy', [
                'The Annals of Castle Black (R)', 'A Noble Cause',
                'Wildling Horde', 'Lannisport Merchant', 'The Iron Bank Will Have Its Due', 'Hear Me Roar!', 'Tithe', 'Ahead of the Tide'
            ]);
            ...
            this.eventCard2 = this.player1.findCardByName('The Iron Bank Will Have Its Due', 'hand');
