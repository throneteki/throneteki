    ...
    integration(function() {
        beforeEach(function() {
            const deck1 = this.buildDeck('greyjoy', [
                ...
                'Hotho Humpback', 'The High Sparrow', 'Hedge Knight', 'Hedge Knight', 'Hedge Knight', 'Hedge Knight', 'Hedge Knight', 'Hedge Knight', 'Hedge Knight',
        ...
        describe('when using Hotho', function() {
            ...
            it('should draw a card and then check for reserve', function() {
                ...
                expect(this.player1).toHavePrompt('Select 7 cards to discard down to reserve (top first)');
                expect(this.player2).toHavePrompt('Waiting for opponent to discard down to reserve');
            });
        });
