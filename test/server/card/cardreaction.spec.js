...
describe('CardReaction', function () {
    beforeEach(function () {
        ...
        this.createReaction = () => {
            return new CardReaction(this.gameSpy, this.cardSpy, 'eventType', this.properties);
        };
    });
    ...
    describe('events generated by createEventHandlerFor()', function() {
        beforeEach(function() {
            this.executeEventHandler = (...args) => {
                this.reaction = new CardReaction(this.gameSpy, this.cardSpy, 'eventType', this.properties);
