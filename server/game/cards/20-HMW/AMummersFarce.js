    ...
    setupCardAbilities(ability) {
        ...
        this.forcedReaction({
            ...
            handler: context => {
                ...
                if(topCard) {
                    context.player.attach(context.player, topCard, context.event.card, 'play', true);
                    ...
                    this.game.addMessage('{0} uses {1} to attach the top card of their deck under {2}', context.player, this, context.event.card);
                }
            }
        });
    }
