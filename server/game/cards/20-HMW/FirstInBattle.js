        ...
        this.action({
            ...
            handler: context => {
                this.untilEndOfPhase(ability => ({
                    ...
                    match: card => card.getType() === 'character' && (card.hasTrait('Army') || card.hasTrait('House Tarly')),
                    effect: ability.effects.doesNotKneelAsAttacker()
                }));
                
                this.game.addMessage('{0} plays {1} to have each {2} or {3} character they control not kneel during the first challenge they initiate this phase',
                    context.player, this, 'Army', 'House Tarly');
            }
        });
    }
