                    ...
                    GameActions.discardCard(context => ({
                        ...
                        gameAction: GameActions.search({
                            ...
                            message: {
                                ...
                                args: { attackingPlayer: thenContext => thenContext.parentContext.event.challenge.attackingPlayer }
                            },
                            gameAction: GameActions.simultaneously(thenContext => thenContext.searchTarget.map(
