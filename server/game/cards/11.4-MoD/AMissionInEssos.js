    ...
    setupCardAbilities() {
        this.action({
            ...
            handler: () => {
                ...
                this.game.addMessage('{0} uses {1} to replace their deck with their discard pile, shuffle it, and draw {2}', this.controller, this, TextHelper.count(cardsDrawn.length, 'card'));
            }
        });
    }
}
