    ...
    setupCardAbilities(ability) {
        this.reaction({
            ...
            handler: context => {
                ...
                this.game.addMessage('{0} plays {1} and returns {2} to their hand to return {3} to {4}\'s hand',
                    context.player, this, context.costs.returnToHand, context.target, context.target.owner);
            }
        });
    }
}
...
module.exports = APlotAgainstTheQueen;
