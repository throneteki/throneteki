...
class Kingslayer extends DrawCard {
    setupCardAbilities(ability) {
        ...
        this.action({
            ...
            target: {
                cardCondition: card => card.location === 'play area' && card.getType() === 'character' && card.getPower() >= 2,
                gameAction: 'kill'
            },
            handler: context => {
        ...
        this.forcedInterrupt({
            ...
            handler: context => {
                ...
                this.game.addMessage('{0} is forced by {1} to have each opponent gain 2 power for their faction',
                    context.player, this);
            }
        });
    }
