...
class GwynesseHarlaw extends DrawCard {
    setupCardAbilities(ability) {
        this.action({
            ...
            handler: context => {
                this.game.addMessage('{0} uses {1} to place {2} on the bottom of {3}\'s deck', context.player, this, context.target);
                ...
                this.game.addMessage('Then {0} draws {2} card and gains {3} gold', context.player, this, numCardsDrawn, goldGained);
            }
        });
    }
}
