    ...
    setupCardAbilities(ability) {
        this.reaction({
            ...
            handler: context => {
                ...
                let cards = this.controller.filterCardsInPlay(card => card.hasTrait('Raider') && card.getType() === 'character' && card.isParticipating() && card.controller === this.controller && card.location === 'play area');
                if(cards.length > 0) {
