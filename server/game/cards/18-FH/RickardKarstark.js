...
class RickardKarstark extends DrawCard {
    setupCardAbilities(ability) {
        this.action({
            ...
            cost: ability.costs.kneel(card => card.getType() === 'location' && card.hasTrait('The North')),
            target: {
                type: 'select',
                choosingPlayer: 'each',
                ifAble: true,
        ...
        this.reaction({
            ...
            handler: context => {
                ...
                this.game.addMessage('{0} uses {1} to move {2} from their discard pile to their hand',
...
module.exports = RickardKarstark;
