        ...
        this.reaction({
            ...
            target: {
                ...
                cardCondition: (card, context) =>
                    card.location === 'shadows' && card.controller === context.event.challenge.loser
            },
            handler: (context) => {
