...
class GiftsForTheWidow extends DrawCard {
    ...
    cardSelected(context, attachment) {
        this.game.addMessage('{0} plays {1} and pays {2} gold to search their deck and finds {3}', context.player, this, context.xValue, attachment);
    ...
    doneSelecting(context) {
        this.game.addMessage('{0} plays {1} and pays {2} gold to search their deck but does not find a card', context.player, this, context.xValue);
    }
}
