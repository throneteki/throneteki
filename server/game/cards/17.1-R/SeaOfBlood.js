...
class SeaOfBlood extends AgendaCard {
    setupCardAbilities(ability) {
        this.action({
            ...
            message: '{player} discards 1 blood token from {source} to reduce the cost of the next event they play this phase by 2',
            handler: () => {
        ...
        this.reaction({            
            ...
            message: '{player} uses {source} and kneels their faction card to place 1 blood token on {source}, and search the top 10 cards of their deck for an event',
