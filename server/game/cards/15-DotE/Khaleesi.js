...
class Khaleesi extends DrawCard {
    setupCardAbilities(ability) {
        ...
        this.reaction({
            when: {
                afterChallenge: event => event.challenge.winner === this.controller && event.challenge.isParticipating(this.parent)
            },
            ...
            choices: {
                ...
                'Raise claim': () => {
                    ...
                    this.game.addMessage('{0} kneels {1} to raise the claim value on their revealed plot card by 1 until the end of the challenge',
